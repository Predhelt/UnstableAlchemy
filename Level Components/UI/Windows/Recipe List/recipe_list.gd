...
var recipe_item_icon : PackedScene = preload("res://Level Components/UI/Windows/Recipe List/recipe_item_icon.tscn")
var recipe_tool_icon : PackedScene = preload("res://Level Components/UI/Windows/Recipe List/recipe_tool_icon.tscn")
var recipe_ingredient_icons : PackedScene = preload("res://Level Components/UI/Windows/Recipe List/recipe_item_icon.tscn")
var recipe_procedure_icons : PackedScene = preload("res://Level Components/UI/Windows/Recipe List/recipe_procedure_icons.tscn")
var procedure_icon_grind := preload("res://Art/Packs/UAPrototype/UI/Minigame/grind.png")
var procedure_icon_crush := preload("res://Art/Packs/UAPrototype/UI/Minigame/crush.png")
var procedure_icon_bellows := preload("res://Art/Packs/UAPrototype/UI/Minigame/bellows.png")

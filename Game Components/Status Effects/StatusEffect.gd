...
@export_enum("move speed", "grow", "cleanse", "normalize") var effect : String ## Identifier for the effect
@export var value := 0.0 ## Amount/Mult to change the player's stat by. use negative value for stat reduction

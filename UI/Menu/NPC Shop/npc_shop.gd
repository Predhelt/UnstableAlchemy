...
#TODO: Determine if icons for shop items and costs should be preloaded
#var shop_item_icon : PackedScene = preload("res://UI/Menu/Recipe List/recipe_item_icon.tscn")
#var shop_cost_icons : PackedScene = preload("res://UI/Menu/Recipe List/recipe_ingredient_icons.tscn")
...
func open_window() -> void:
	if global.mode == &"default" or global.mode == &"menu" or global.mode == &"minigame":
		...
		for item in shop:
			...
			%ShopItems.add_item(display_text, item.texture)
